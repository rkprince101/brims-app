...
import {
  ...
  Package, Receipt, CheckCircle2, Truck, Clock, Pencil, Trash2, Link as LinkIcon, Link2Off, X
} from "lucide-react";
...
// ========== Procurement Section ==========
function ProcurementSection({ procurements, addProcurement, updateProcurement, deleteProcurement, crvs = [], isClosed, isEditingUnlocked }) {
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-20 animate-fade-in">
      ...
      {isTest ? (
        ...
        <div className="space-y-6">
          ...
          <ProcurementSection procurements={allProcurements} addProcurement={addProcurement} updateProcurement={updateProcurement} deleteProcurement={deleteProcurement} crvs={allCRVs} isClosed={isClosed} isEditingUnlocked={isEditingUnlocked} />
