...
export default function JobCardDetailPage() {
  ...
  const isTest = jobCard.workOrder?.workType === "KPL_LPH_TEST";

  return (
    <div className="relative">
      <StatusSidebar status={jobCard.status} isTest={isTest} />
      <div className="pr-[240px]">
        <JobCardDetail jobCard={jobCard} onUpdate={handleUpdate} onBack={handleBack} />
      </div>
    </div>
  );
}
